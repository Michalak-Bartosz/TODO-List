...
IFontDisp = Font
__all__ = [ 'OLE_XSIZE_PIXELS', 'Gray', 'OLE_COLOR',
           'OLE_YSIZE_HIMETRIC', 'OLE_XPOS_CONTAINER',
           'OLE_OPTEXCLUSIVE', 'Monochrome', 'OLE_XSIZE_CONTAINER',
           'OLE_YSIZE_PIXELS', 'FONTUNDERSCORE', 'Font', 'VgaColor',
           'OLE_YPOS_HIMETRIC', 'IFontDisp', 'LoadPictureConstants',
           'OLE_XSIZE_HIMETRIC', 'OLE_XPOS_HIMETRIC', 'StdPicture',
           'Checked', 'OLE_CANCELBOOL', 'Default', 'IPictureDisp',
           'OLE_ENABLEDEFAULTBOOL', 'FONTNAME', 'Picture',
           'OLE_XPOS_PIXELS', 'FONTBOLD', 'FONTITALIC', 'StdFont',
           'OLE_YPOS_CONTAINER', 'Unchecked', 'OLE_HANDLE',
           'FONTSIZE', 'OLE_TRISTATE', 'Color', 'IFontEventsDisp',
           'OLE_YPOS_PIXELS', 'IPicture', 'OLE_YSIZE_CONTAINER',
           'FontEvents', 'IFont', 'FONTSTRIKETHROUGH']
